...
_Circular dependencies_ are dependencies of instances that depend on each other. To define circular dependencies in NSInject, one of the dependencies must be injected through a property.
